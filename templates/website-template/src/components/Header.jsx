    ...
    <header className="header">
      <div className="header-content">
        ...
        <nav className="nav">
          ...
          <Link to="/library-graph" className={isActive('/library-graph') ? 'nav-link active' : 'nav-link'}>
            📚 Libraries
          </Link>
          <Link to="/application-graph" className={isActive('/application-graph') ? 'nav-link active' : 'nav-link'}>
            🚀 Applications
          </Link>
