...
class ApplicationEdge:
    """Represents an interaction edge between two applications.

    Populated during application analysis when code-analyzer subagents
    discover application-to-application interactions.
    """
...
class DependencyGraph:
    ...
    def get_analysis_order(self) -> Tuple[List[str], List[str]]:
        ...
        # Phase 1: Services with no dependencies (no outgoing edges)
